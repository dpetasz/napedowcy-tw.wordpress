        ...
        <div class="site-footer__main">
            ...
            <div class="site-footer__nav site-footer__order">
                <ul>
                    ...
                    <li
                        <?php if((is_page('performances') or get_post_type()=='performance') and !get_field('archive') )echo 'class="site-footer--current"' ?>>
                    ...
                    <li
                        <?php if(is_page('archival-performances')or get_field('archive')) echo 'class="site-footer--current"' ?>>
